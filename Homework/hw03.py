...
def missing_digits(n):
    ...
    if n < 10:
        ...
        cal = y % 10
        if cal == x or x - cal == 1:
            return missing_digits(y)
        elif x - cal > 1:
            return (x - cal - 1) + missing_digits(y)
...
def count_change(total):
    ...
    True
    """
    def change_helper(total, small_coin): #HW3's video, ppt, section1.7 on count_partitions.
